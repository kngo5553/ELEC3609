(function() {
	...
	var pubnub = PUBNUB.init({
		publish_key     : 'pub-c-8ee800d7-c319-48d3-9bd2-6fe5f4fec9c6',
		subscribe_key   : 'sub-c-ef2a414e-5a7a-11e4-9f5a-02ee2ddab7fe',
	...
	pubnub.subscribe({
		...
		presence: function(m){
			if(m.occupancy > 1){
				document.getElementById('unit').textContent = 'Students';
			}
